...
0. Make a commit out of your changes
    ...
    See our page on [patches](/course/spring2025-utsa/faq/patches) for more information on the DCO.
...
0. Next, you'll want to create a patch series, also known as a [patchset](/course/spring2025-utsa/faq/patchsets), with a [cover letter](/course/spring2025-utsa/faq/coverletters) out of your [commits](/course/spring2025-utsa/faq/commits).
...
in your text editor so that you can write your cover letter according to the [guidelines](/course/spring2025-utsa/faq/coverletters).
